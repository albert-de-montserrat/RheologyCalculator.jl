...
@inline compute_porosity_rate(r::Poroviscosity; pf = 0, p̄ = 0, kwargs...) = (pf - p̄) / r.ηΦ
...
@inline function compute_porosity_rate(r::Poroelasticity; pf = 0, p̄ = 0, pf0 = 0, p̄0 = 0, dt = Inf, kwargs...) 
    dp̄dt  = (p̄ - p̄0) / dt
    dpfdt = (pf - pf0) / dt
